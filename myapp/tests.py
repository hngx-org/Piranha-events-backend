...
class EventAPITestCase(TestCase):
    ...
    def test_create_event(self):
        ...
        data = {
            ...
            'creator_id': 1,  # Replace with a valid user ID
            'location': 'Test Location',
            'start_date': '2023-09-20',
            'end_date': '2023-09-21',
            'start_time': '2023-09-20T10:00:00Z',
            'end_time': '2023-09-21T12:00:00Z',
            'thumbnail': '',  # Add the path or URL to a test image
        }
    ...
    def test_get_event_details(self):
        event = Event.objects.create(name='Test Event', description='Test description')
    ...
    def test_update_event_details(self):
        event = Event.objects.create(name='Test Event', description='Test description')
        url = reverse('event-detail', args=[event.id])
        data = {'name': 'Updated Event Name', 'description': 'Updated description'}
